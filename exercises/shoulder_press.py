...
def detect():
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while cap.isOpened():
            ...
            if results.pose_landmarks:  # Check if landmarks are detected
                try:
                    ...
                    # Curl counter logic
                    if angle1 > 160 and angle2 > 160 and angle3 > 70:
                        stage = "UP"
                        form = "CORRECT"
                    if angle1 < 90 and angle2 < 90 and stage == 'UP':
                        ...
                        counter += 1
                        print(counter)
                    elif angle3 > 120 and stage == 'DOWN':
                        form = "INCORRECT"
            ...
            cv2.putText(image, 'SHOULDER PRESS', (275, 25),
            ...
            cv2.putText(image, 'STAGE', (65, 12),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 215, 0), 1, cv2.LINE_AA)
            cv2.putText(image, stage or "N/A",
                        (60, 60),
                        cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)

            cv2.putText(image, 'FORM', (15, 90),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 215, 0), 1, cv2.LINE_AA)
            cv2.putText(image, form or "N/A",
                        (15, 115),
        ...
        return "SHOULDER PRESS DETECTION RESULT", counter, elapsed_time_formatted, calories_burnt
